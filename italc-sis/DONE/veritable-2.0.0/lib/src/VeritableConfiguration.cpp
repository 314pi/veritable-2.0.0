/*
 * VeritableConfiguration.cpp - a Configuration object storing system wide
...
VeritableConfiguration::VeritableConfiguration(
...
VeritableConfiguration::VeritableConfiguration( Configuration::Store *store ) :
...
VeritableConfiguration::VeritableConfiguration( const VeritableConfiguration &ref ) :
...
VeritableConfiguration VeritableConfiguration::defaultConfiguration()
{
	VeritableConfiguration c( Configuration::Store::NoBackend );
...
FOREACH_VERITABLE_CONFIG_PROPERTY(IMPLEMENT_CONFIG_SET_PROPERTY)
