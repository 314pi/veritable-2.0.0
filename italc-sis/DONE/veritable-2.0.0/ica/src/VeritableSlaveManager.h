/*
 * VeritableSlaveManager.h - VeritableSlaveManager which manages (GUI) slave apps
 *
...
#ifndef _VERITABLE_SLAVE_MANAGER_H
#define _VERITABLE_SLAVE_MANAGER_H

#include "Ipc/Master.h"
#include "DemoServerMaster.h"


class VeritableSlaveManager : protected Ipc::Master
{
	Q_OBJECT
public:
	VeritableSlaveManager();
	virtual ~VeritableSlaveManager();
