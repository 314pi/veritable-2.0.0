...
// there's one instance of a DemoServer on the vERITABLE master
...
class DemoServerClient : public QThread
{
	Q_OBJECT
public:
	DemoServerClient( int sock, const VeritableVncConnection *vncConn,
							DemoServer *parent );
...
private slots:
	...
	// called whenever VeritableVncConnection::cursorShapeUpdated() is emitted
...
private:
	...
	QTcpSocket *m_sock;
	const VeritableVncConnection *m_vncConn;
