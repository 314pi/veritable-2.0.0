...
{
	if( m.cmd() == VeritableSlaveManager::DemoClient::StartDemo )
	{
		m_demoClient = new DemoClient( m.arg( VeritableSlaveManager::DemoClient::MasterHost ),
										m.argV( VeritableSlaveManager::DemoClient::FullScreen ).toInt() );
		return true;
	}
