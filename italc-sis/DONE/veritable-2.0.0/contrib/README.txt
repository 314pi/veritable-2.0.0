ADMX files for Active Directory integration of vERITABLE have been provided by
...
vERITABLE 2. Each of the policies when created will control the parameters in use
created/modified when using the vERITABLE Management Console.
