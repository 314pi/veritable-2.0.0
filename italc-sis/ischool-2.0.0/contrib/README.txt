ADMX files for Active Directory integration of iSCHOOL have been provided by
...
iSCHOOL 2. Each of the policies when created will control the parameters in use
created/modified when using the iSCHOOL Management Console.
