...
{
	if( m.cmd() == IschoolSlaveManager::DemoClient::StartDemo )
	{
		m_demoClient = new DemoClient( m.arg( IschoolSlaveManager::DemoClient::MasterHost ),
										m.argV( IschoolSlaveManager::DemoClient::FullScreen ).toInt() );
		return true;
	}
