...
{
	if( m.cmd() == IschoolSlaveManager::SystemTrayIcon::SetToolTip )
	{
		m_systemTrayIcon.setToolTip(
					m.arg( IschoolSlaveManager::SystemTrayIcon::ToolTipText ) );
		return true;
	}
	else if( m.cmd() == IschoolSlaveManager::SystemTrayIcon::ShowMessage )
	{
		m_systemTrayIcon.showMessage(
					m.arg( IschoolSlaveManager::SystemTrayIcon::Title ),
					m.arg( IschoolSlaveManager::SystemTrayIcon::Text ) );
		return true;
	}
