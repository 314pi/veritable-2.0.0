/*
 * IschoolSlaveManager.h - IschoolSlaveManager which manages (GUI) slave apps
 *
...
#ifndef _ISCHOOL_SLAVE_MANAGER_H
#define _ISCHOOL_SLAVE_MANAGER_H

#include "Ipc/Master.h"
#include "DemoServerMaster.h"


class IschoolSlaveManager : protected Ipc::Master
{
	Q_OBJECT
public:
	IschoolSlaveManager();
	virtual ~IschoolSlaveManager();
