...
// there's one instance of a DemoServer on the iSCHOOL master
...
class DemoServerClient : public QThread
{
	Q_OBJECT
public:
	DemoServerClient( int sock, const IschoolVncConnection *vncConn,
							DemoServer *parent );
...
private slots:
	...
	// called whenever IschoolVncConnection::cursorShapeUpdated() is emitted
...
private:
	...
	QTcpSocket *m_sock;
	const IschoolVncConnection *m_vncConn;
