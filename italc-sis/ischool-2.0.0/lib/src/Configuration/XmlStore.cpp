...
{
	QDomDocument doc( "IschoolXmlStore" );
...
QString XmlStore::configurationFilePath() const
{
	...
	{
		case Global:
			base = IschoolConfiguration::defaultConfiguration().globalConfigurationPath();
			break;
		case Personal:
			base = IschoolConfiguration::defaultConfiguration().personalConfigurationPath();
			break;
		case System:
