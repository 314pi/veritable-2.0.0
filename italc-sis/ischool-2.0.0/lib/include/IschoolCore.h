/*
 * IschoolCore.h - definitions for iSCHOOL Core
 *
...
#ifndef _ISCHOOL_CORE_H
#define _ISCHOOL_CORE_H
...
namespace IschoolCore
{
	...
	extern IschoolConfiguration *config;
	...
	typedef QList<QPair<IschoolCore::Command, IschoolCore::CommandArgs> >
								CommandList;
