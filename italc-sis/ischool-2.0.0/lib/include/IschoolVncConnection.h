/*
 * IschoolVncConnection.h - declaration of IschoolVncConnection class
 *
...
#ifndef _ISCHOOL_VNC_CONNECTION_H
#define _ISCHOOL_VNC_CONNECTION_H
...
class IschoolVncConnection: public QThread
{
	Q_OBJECT
public:
	enum QualityLevels
	...
	explicit IschoolVncConnection( QObject *parent = 0 );
	virtual ~IschoolVncConnection();
	...
	void setIschoolAuthType( IschoolAuthType t )
	{
		m_ischoolAuthType = t;
	}

	IschoolAuthType ischoolAuthType() const
	{
		return m_ischoolAuthType;
	}
	...
	// authentication
	static void handleSecTypeIschool( rfbClient *client );
...
private:
	...
	static rfbBool hookHandleIschoolMessage( rfbClient *cl,
						rfbServerToClientMsg *msg );

	uint8_t *m_frameBuffer;
	bool m_framebufferInitialized;
	rfbClient *m_cl;
	IschoolAuthType m_ischoolAuthType;
