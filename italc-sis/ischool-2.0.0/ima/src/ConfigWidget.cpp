...
ConfigWidget::ConfigWidget( MainWindow * _main_window, QWidget * _parent ) :
	SideBarWidget( QPixmap( ":/resources/config.png" ),
			tr( "Your iSCHOOL-configuration" ),
			tr( "In this workspace you can customize iSCHOOL to "
				"fit your needs." ),
...
#define LOAD_AND_CONNECT_PROPERTY(property,type,widget,setvalue,signal,slot) \
	...
	roleCB->setCurrentIndex( IschoolCore::role - 1 );
...
{
	IschoolCore::role = static_cast<IschoolCore::UserRole>( _role );
}
