/*
 * MainWindow.h - main-window of iSCHOOL
 *
...
class UserList;
class IschoolCoreConnection;
class IschoolVncConnection;
...
public:
	...
	IschoolCoreConnection *localICA()
	{
		return m_localICA;
	}
...
private:
	...
	IschoolCoreConnection * m_localICA;
