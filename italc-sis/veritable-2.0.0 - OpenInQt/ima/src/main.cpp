/*
 * main.cpp - main-file for vERITABLE Master Application
 *
...
// good old main-function... initializes qt-app and starts vERITABLE
int main( int argc, char * * argv )
{
	...
	while( argc > 1 && arg_it.hasNext() )
	{
		...
		if( a == "-rctrl" && arg_it.hasNext() )
		{
			...
			{
				ilog_failed( "VeritableCore::initAuthentication()" );
				return -1;
			}
