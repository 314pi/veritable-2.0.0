...
{
	if( m.cmd() == VeritableSlaveManager::AccessDialog::Ask )
	{
		QString user = m.arg( VeritableSlaveManager::AccessDialog::User );
		QString host = m.arg( VeritableSlaveManager::AccessDialog::Host );
		int choiceFlags = m.argV( VeritableSlaveManager::AccessDialog::ChoiceFlags ).toInt();

		choiceFlags = exec( user, host, choiceFlags );

		Ipc::Msg( VeritableSlaveManager::AccessDialog::ReportChoice ).
			addArg( VeritableSlaveManager::AccessDialog::ChoiceFlags, choiceFlags ).
				send( this );
