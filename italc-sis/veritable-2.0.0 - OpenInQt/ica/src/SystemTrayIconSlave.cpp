...
{
	if( m.cmd() == VeritableSlaveManager::SystemTrayIcon::SetToolTip )
	{
		m_systemTrayIcon.setToolTip(
					m.arg( VeritableSlaveManager::SystemTrayIcon::ToolTipText ) );
		return true;
	}
	else if( m.cmd() == VeritableSlaveManager::SystemTrayIcon::ShowMessage )
	{
		m_systemTrayIcon.showMessage(
					m.arg( VeritableSlaveManager::SystemTrayIcon::Title ),
					m.arg( VeritableSlaveManager::SystemTrayIcon::Text ) );
		return true;
	}
