/*
 * VeritableVncConnection.h - declaration of VeritableVncConnection class
 *
...
#ifndef _VERITABLE_VNC_CONNECTION_H
#define _VERITABLE_VNC_CONNECTION_H
...
class VeritableVncConnection: public QThread
{
	Q_OBJECT
public:
	enum QualityLevels
	...
	explicit VeritableVncConnection( QObject *parent = 0 );
	virtual ~VeritableVncConnection();
	...
	void setVeritableAuthType( VeritableAuthType t )
	{
		m_veritableAuthType = t;
	}

	VeritableAuthType veritableAuthType() const
	{
		return m_veritableAuthType;
	}
	...
	// authentication
	static void handleSecTypeVeritable( rfbClient *client );
...
private:
	...
	static rfbBool hookHandleVeritableMessage( rfbClient *cl,
						rfbServerToClientMsg *msg );

	uint8_t *m_frameBuffer;
	bool m_framebufferInitialized;
	rfbClient *m_cl;
	VeritableAuthType m_veritableAuthType;
