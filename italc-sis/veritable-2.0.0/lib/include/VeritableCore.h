/*
 * VeritableCore.h - definitions for vERITABLE Core
 *
...
#ifndef _VERITABLE_CORE_H
#define _VERITABLE_CORE_H
...
namespace VeritableCore
{
	...
	extern VeritableConfiguration *config;
	...
	typedef QList<QPair<VeritableCore::Command, VeritableCore::CommandArgs> >
								CommandList;
