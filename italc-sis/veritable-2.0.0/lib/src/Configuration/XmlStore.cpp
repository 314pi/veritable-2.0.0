...
{
	QDomDocument doc( "VeritableXmlStore" );
...
QString XmlStore::configurationFilePath() const
{
	...
	{
		case Global:
			base = VeritableConfiguration::defaultConfiguration().globalConfigurationPath();
			break;
		case Personal:
			base = VeritableConfiguration::defaultConfiguration().personalConfigurationPath();
			break;
		case System:
