/*
 * MainWindow.h - main-window of vERITABLE
 *
...
class UserList;
class VeritableCoreConnection;
class VeritableVncConnection;
...
public:
	...
	VeritableCoreConnection *localICA()
	{
		return m_localICA;
	}
...
private:
	...
	VeritableCoreConnection * m_localICA;
