...
#include "../../../veritable-2.0.0 - OpenInQt/lib/include/VeritableCoreConnection.h"
...
void VeritableCoreConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        VeritableCoreConnection *_t = static_cast<VeritableCoreConnection *>(_o);
        switch (_id) {
        case 0: _t->initNewClient((*reinterpret_cast< rfbClient*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData VeritableCoreConnection::staticMetaObjectExtraData = {
...
const QMetaObject VeritableCoreConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VeritableCoreConnection,
      qt_meta_data_VeritableCoreConnection, &staticMetaObjectExtraData }
};
