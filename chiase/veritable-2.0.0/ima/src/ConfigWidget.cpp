...
ConfigWidget::ConfigWidget( MainWindow * _main_window, QWidget * _parent ) :
	SideBarWidget( QPixmap( ":/resources/config.png" ),
			tr( "Your vERITABLE-configuration" ),
			tr( "In this workspace you can customize vERITABLE to "
				"fit your needs." ),
...
#define LOAD_AND_CONNECT_PROPERTY(property,type,widget,setvalue,signal,slot) \
	...
	roleCB->setCurrentIndex( VeritableCore::role - 1 );
...
{
	VeritableCore::role = static_cast<VeritableCore::UserRole>( _role );
}
